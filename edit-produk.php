		...
		<div class="countainer">
			...
			<div class="box">
				<form action="" method="POST" enctype="multipart/form-data">
					...
					<img src="produk/<?php echo $p->prodeuct_image ?>" width="130px">
					<input type="hidden" name="foto" value="<?php echo $p->prodeuct_image ?>">
					...
					<?php 
						if(isset($_POST['submit'])){
							...
							// menumoung data format file yang diizinkan
							$type_diizinkan = array('jpg', 'png', 'jpeg', 'gif');
